...
namespace NS_TEAM_IMPROVED {
	...
	void teamImproved(string teamName,vector <NS_DATA::teamData>& prevYear,vector <NS_DATA::teamData>& currYear) {
		int winDiff;
		double adjODiff;
		double adjDDiff;
		int rankDiff;
		size_t pos1 = -1;
		size_t pos2 = -1;
		string improved = "has not improved since 2017!\n";
		...
		if (winDiff > 0) {
			improved = "has improved from 2017-2018!\n";
		}
		else if (adjODiff > 0) {
			improved = "has improved from 2017-2018!\n";
		}
